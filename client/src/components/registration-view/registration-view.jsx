    ...
    <Container className="registration-view" fluid="true">
      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit} className="registration-form">
        ...
        <Form.Group controlId="formBirthday">
          ...
          <Form.Control type="date" placeholder="Enter birthdate" min="1900-01-01" max={new Date().toISOString().split('T')[0]} value={birth_date} required onChange={e => setBirthDate(e.target.value)} />
          <Form.Control.Feedback type="invalid">
